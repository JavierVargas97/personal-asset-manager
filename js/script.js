...
const submitSelection = (event) => {
    ...
    selectAssetLabel.style.cssText = 'display:block;'
    cryptoSearch.value = "";
    holdings.value = "";
...
const getCrypto = async () => {
    ...
    data.forEach(item => {
        ...
        cryptoBtnIndividual.classList.add("mb-2", "px-4", "py-1", "shrink", "text-center", "mx-auto", "flex", "justify-center", "block", "text-lg", "text-neutral-300", "rounded-full", "border", "border-gray-400", "hover:text-white", "hover:bg-gray-400", "hover:border-transparent", "focus:outline-none", "focus:ring-2", "focus:ring-purple-600", "focus:ring-offset-2");
